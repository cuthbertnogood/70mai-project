...
# Прогресс (отдельное окно): copy/merge/compose/upload; prefetch — строка в «этапах» (► пока import жив; · ждёт — ch.N + причина если пауза, напр. disk < reserve); prefetch import следующего чанка параллельно compose;
